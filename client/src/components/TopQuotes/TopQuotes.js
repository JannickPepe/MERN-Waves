...
const TopQuotes = ({ _id, topquotestitle, topquotestext, topquotesauthor, createdAt, isTopQuotesPage }) => {
    ...
    return (
        <div className="">
            <div className="group relative w-full max-w-sm overflow-hidden rounded-lg bg-slate-800 p-0.5 transition-all duration-500 hover:scale-[1.01] hover:bg-slate-800/50">
                <div className="relative z-10 overflow-hidden rounded-[7px] bg-slate-900 p-8 transition-colors duration-500 group-hover:bg-slate-800">
                    <BiSolidQuoteAltRight className="relative mx-auto z-10 mb-10 mt-2 rounded-full border-2 border-indigo-500 bg-slate-900 p-4 text-7xl text-indigo-500" />
